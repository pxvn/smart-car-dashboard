...
<body>
    <div class="dashboard-container">
        <div class="road-container">
            ...
            <!-- Other Car (Gray) -->
            <svg id="other-car" class="car-svg" viewBox="0 0 100 180">
            ...
            <div class="control-card">
                <svg class="compass" viewBox="0 0 100 100">
                    ...
                    <g class="compass-needle" id="compass-needle">
                        <path d="M50 15 L45 25 L55 25 Z" fill="#DC143C"/>
                        <path d="M50 85 L45 75 L55 75 Z" fill="#666"/>
                    </g>
                    <text x="50" y="10" font-size="10" fill="#fff" text-anchor="middle" font-weight="600">N</text>
                    <text x="50" y="95" font-size="10" fill="#fff" text-anchor="middle" font-weight="600">S</text>
                    <text x="10" y="54" font-size="10" fill="#fff" text-anchor="middle" font-weight="600">W</text>
                    <text x="90" y="54" font-size="10" fill="#fff" text-anchor="middle" font-weight="600">E</text>
                </svg>
            </div>
        </div>
        ...
        <div class="side-controls right">
            <div class="control-card">
                <svg class="speedometer" viewBox="0 0 100 100">
                    <path d="M25 75 A35 35 0 0 1 75 75" stroke="#666" stroke-width="3" fill="none"/>
                    <text id="speed-value" x="50" y="65" text-anchor="middle" font-size="20" font-weight="600" fill="#fff">0</text>
                    <text x="50" y="78" text-anchor="middle" font-size="8" fill="#fff" opacity="0.7">MPH</text>
                </svg>
            </div>
        </div>
    ...
    <script>
        ...
        function updateObstacle(frontDist, backDist) {
            ...
            if (frontDist < 12) {
                ...
                distance = frontDist;
                position = 'front';
                label = frontDist < 6 ? 'DANGER - FRONT' : 'OBSTACLE - FRONT';
            } else if (backDist < 12) {
                showObstacle = true;
                distance = backDist;
                position = 'back';
                label = backDist < 6 ? 'DANGER - BACK' : 'OBSTACLE - BACK';
            }
            ...
            if (showObstacle) {
                ...
                elements.distanceCard.classList.toggle('danger', distance < 6);
            } else {
